        ...
        children: [
          ...
          Form(
            ...
            child: TextFormField(
              ...
              decoration: const InputDecoration(
                hintText: "Enter OTP",
                hintStyle:
                    TextStyle(color: kPrimaryColor), // Color del texto del hint
                focusedBorder: OutlineInputBorder(
                  borderSide: BorderSide(
                      color:
                          kPrimaryColor), // Color del borde cuando está enfocado
                ),
                border: OutlineInputBorder(
                  borderSide: BorderSide(
                      color: Colors.grey), // Color del borde predeterminado
                ),
              ),
            ),
          ),
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              minimumSize:
                  const Size(200, 50), // Tamaño mínimo del botón (ancho, alto)
              shape: RoundedRectangleBorder(
                borderRadius:
                    BorderRadius.circular(10), // Radio de los bordes del botón
              ),
            ),
