...
class Sensor extends amplify_core.Model {
  ...
  SensorModelIdentifier get modelIdentifier {
    return SensorModelIdentifier(id: id);
  }
  ...
  const Sensor._internal(
      {required this.id, humidity, temperature, createdAt, updatedAt})
      : _humidity = humidity,
        _temperature = temperature,
        _createdAt = createdAt,
        _updatedAt = updatedAt;

  factory Sensor({String? id, double? humidity, double? temperature}) {
  ...
  Sensor copyWith({double? humidity, double? temperature}) {
    return Sensor._internal(
        id: id,
  ...
  Sensor copyWithModelFieldValues(
    ...
    return Sensor._internal(
        ...
        temperature:
            temperature == null ? this.temperature : temperature.value);
  }
  ...
  static final amplify_core.QueryModelIdentifier<SensorModelIdentifier>
      MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<SensorModelIdentifier>();
...
class SensorModelIdentifier implements amplify_core.ModelIdentifier<Sensor> {
  ...
  const SensorModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is SensorModelIdentifier && id == other.id;
  }
